 ...
 *
 * NOTE: DRAFT -- not yet compiled/link-checked (authored on a WSL2 box with
 * no kernel headers). See HANDOFF.md for the modpost verification step to
 * run on an Ubuntu 26.04 / kernel 7.0 target.
 */
